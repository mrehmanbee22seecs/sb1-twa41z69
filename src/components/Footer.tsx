            ...
            <div className="mb-8">
              ...
              <div className="flex max-w-md">
                <input
                  ...
                  className="flex-1 px-6 py-4 bg-navy-midnight/60 border-2 border-gold-accent/30 rounded-l-luxury text-cream-soft placeholder-cream-soft/60 focus:outline-none focus:border-gold-accent font-luxury-body backdrop-blur-luxury"
